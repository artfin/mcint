...
const double mu1 = 7.9997 * dalton / amu; // amu, CO2
const double mu2 = 0.50397 * dalton / amu; // amu, H2
const double mu3 = 1.9276 * dalton / amu; // amu, mu(CO2+H2)
const double l1 = 4.398; // bohrs, CO2
const double l2 = 1.4003; // bohrs, H2

const double l1_sq = l1 * l1;
const double l2_sq = l2 * l2;

void fill_inertia_tensor(Matrix3d &inertia_tensor, double &q1, double &q2, double &q3, double &q4)//Theta1(CO2), Phi, Theta2(H2), R
{
