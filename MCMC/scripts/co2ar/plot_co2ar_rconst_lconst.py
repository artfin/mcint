...
#-----------------------------------------------------------------------------------------
theta_lb_20, theta_rb_20, theta_20 = read_file( '../../out/co2ar/co2ar_rconst_lconst/20/theta.txt' )
...
pr_lb_20, pr_rb_20, pr_20 = read_file( '../../out/co2ar/co2ar_rconst_lconst/20/pr.txt' )
...
ptheta_lb_20, ptheta_rb_20, ptheta_20 = read_file( '../../out/co2ar/co2ar_rconst_lconst/20/pt.txt' )
...
jx_lb_20, jx_rb_20, jx_20 = read_file( '../../out/co2ar/co2ar_rconst_lconst/20/jx.txt' )
...
jy_lb_20, jy_rb_20, jy_20 = read_file( '../../out/co2ar/co2ar_rconst_lconst/20/jy.txt' )
...
jz_lb_20, jz_rb_20, jz_20 = read_file( '../../out/co2ar/co2ar_rconst_lconst/20/jz.txt' )
...
l2_lb_20, l2_rb_20, l2_20 = read_file( '../../out/co2ar/co2ar_rconst_lconst/20/l2.txt' )
l2_lb_50, l2_rb_50, l2_50 = read_file( '../../out/co2ar/co2ar_rconst_lconst/50/l2.txt' )
l2_lb_100, l2_rb_100, l2_100 = read_file( '../../out/co2ar/co2ar_rconst_lconst/100/l2.txt' )
#-----------------------------------------------------------------------------------------
...
l2_med_20 = [ 0.5 * (lb + ub) for lb, ub in zip( l2_lb_20, l2_rb_20) ]
l2_med_50 = [ 0.5 * (lb + ub) for lb, ub in zip( l2_lb_50, l2_rb_50) ]
l2_med_100 = [ 0.5 * (lb + ub) for lb, ub in zip( l2_lb_100, l2_rb_100) ]
#-----------------------------------------------------------------------------------------
